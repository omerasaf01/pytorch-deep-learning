# Derin öğrenme için PyTorch Eğitimi

[Sıfırdan ustalığa PyTorch Dein Öğrenme Kursu'na](https://dbourke.link/ZTMPyTorch), internetteki en iyi ikinci pytorch öğrenme adresine hoşgeldiniz. (İlki [PyTorch dokümantasyonu](https://pytorch.org/docs/stable/index.html)).

- **Nisan 2023 Güncellemesi:** Yeni [PyTorch 2.0 kursu](https://www.learnpytorch.io/pytorch_2_intro/) yayında. PyTorch 2.0 geriye dönük sürümlerle uyumlu olduğundan tüm kurs materyalleri PyTorch 2.0 için geçerli olacaktır.
...
## Bu sayfadaki içerikler

- [Ders materyalleri/taslak](https://github.com/mrdbourke/pytorch-deep-learning#course-materialsoutline)
- [Kurs hakkında](https://github.com/mrdbourke/pytorch-deep-learning#about-this-course)
- [Durum](https://github.com/mrdbourke/pytorch-deep-learning#status) (Kurs oluşturma adımlarının ilerleyişi)
- [Log](https://github.com/mrdbourke/pytorch-deep-learning#log) (Kurs materyallerinin oluşturulma sürecinin logu)

## Ders materyalleri/taslak

- 📖 **Online Kitap Hali:** Tüm kurs içeriği online kitap şeklinde [learnpytorch.io](https://learnpytorch.io) adresinde mevcut.
- 🎥 **YouTube'da ilk 5 bölüm:** PyTorch'u [kursun ilk 25 saatlik içeriği](https://youtu.be/Z_ikDlimN6A) ile izleyerek öğren.
- 🔬 **Kursun odağı:** kod yaz, kod yaz, kod yaz, deney/gözlemey, deney/gözlem, deney/gözlem.
- 🏃‍♂️ **Öğretme tarzı:** [https://sive.rs/kimo](https://sive.rs/kimo).
- 🤔 **Soru sormak için:** soru sormak için veya varolan sorulaır incelemek için [GitHub Discussions page](https://github.com/mrdbourke/pytorch-deep-learning/discussions) sayfasını incele.

| **Bölüm**                                                                                                            | **Neler içeriyor?**                                                                                                                                                                                                                                                                                     | **Egzersizler & Ekstra Şeyelr**                                                                             | **Slaytlar**                                                                                                                      |
| -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [00 - PyTorch Temelleri](https://www.learnpytorch.io/00_pytorch_fundamentals/)                                       | Many fundamental PyTorch operations used for deep learning and neural networks.                                                                                                                                                                                                                         | [Go to exercises & extra-curriculum](https://www.learnpytorch.io/00_pytorch_fundamentals/#exercises)        | [Go to slides](https://github.com/mrdbourke/pytorch-deep-learning/blob/main/slides/00_pytorch_and_deep_learning_fundamentals.pdf) |
